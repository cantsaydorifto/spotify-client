<script lang="ts">
  ...
  import AddToQueue from '$lib/icons/AddToQueue.svelte';
  import Album from '$lib/icons/Album.svelte';
  ...
  import ThreeVerticalDots from '$lib/icons/ThreeVerticalDots.svelte';
  import { addToQueueEnd, playNext, startRadio } from '$lib/store/currentPlaying';
