<script lang="ts">
  ...
  import Playlist from '$lib/icons/Playlist.svelte';
  import SidebarMenu from '$lib/icons/SidebarMenu.svelte';
  ...
  let closeNavbarButton: HTMLButtonElement | null = $state(null);
  let openNavbarButton: HTMLButtonElement | null = $state(null);
  let navLastFocusElement: HTMLAnchorElement | null = $state(null);
